...
{
    public partial class TeacherHM : Sample
    {
        public TeacherHM()
        {
            InitializeComponent();
        ...
        private async void TeacherHM_Load(object sender, EventArgs e)
        {
        ...
        private void pswdCb_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void TeacherHM_Shown(object sender, EventArgs e)
        {
        }
        private void TeacherHM_Paint(object sender, PaintEventArgs e)
        { 
        }
